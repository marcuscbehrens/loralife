#include <lmic.h> // install this from github at https://github.com/matthijskooijman/arduino-lmic
#include <hal/hal.h>
#include <Adafruit_SleepyDog.h> // you have to install the https://github.com/adafruit/Adafruit_ASFcore into your libraries
// to do - write counter to https://learn.adafruit.com/adafruit-feather-m0-express-designed-for-circuit-python-circuitpython/using-spi-flash or to eeprom
...
// cycle limitations).
const unsigned TX_INTERVAL = 5; // 5 seconds plus the watchdog sleep time of 60 
...
void loop(){
  ...
  // how is the control loop in this example?
    ...
    // int sleepMS = Watchdog.sleep(1000);  // Sleep microcontroller for up to 1 second. millis is not updated
    // maybe power converter for 5v board should also be put to sleep to cut off the sensor power completely
    // maybe enable pin should be driven low to save power - but then does the m0 wake up again?
